...
class Date {
    ...
    static void swapDates(
        ...
        firstDate.delimiter = secondDate.delimiter;

        secondDate.day = TEMPORARY_DATE.day;
        secondDate.month = TEMPORARY_DATE.month;
        secondDate.year = TEMPORARY_DATE.year;
        secondDate.delimiter = TEMPORARY_DATE.delimiter;
    }
